...
namespace simplevox
{
    bool VadEngine::init(const VadConfig &config)
    {
        ...
        case VadMode::Aggression_LV0:
            vad_inst_ = new SimpleVAD(0);
            break;
        case VadMode::Aggression_LV1:
            vad_inst_ = new SimpleVAD(1);
            break;
        case VadMode::Aggression_LV2:
            vad_inst_ = new SimpleVAD(2);
            break;
        case VadMode::Aggression_LV3:
            vad_inst_ = new SimpleVAD(3);
            break;
        case VadMode::Aggression_LV4:
            vad_inst_ = new SimpleVAD(4);
            break;
        default:
            vad_inst_ = nullptr;
            break;
